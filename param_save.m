...
[Rmatrices, Rsum, Rsum_DL, R_sqrt_root, Qmatrix, Wmatrix, W_bar, SE_const, SE_const_DL, W_diag, W_bar_diag, SE_const_diag, SE_const_diag_DL] = ConfigRQWC(number_of_cells, number_of_users, number_of_antennas, targetCell, targetUser, mu_val, lambda_DL, alpha_R, Rb, pilotSequenceLength);
